...
main (int argc, char *argv[])
{
  ...
  Tlv::PrintBuffer (std::cout, buffer2);
  ...
  Tlv::PrintBuffer (std::cout, bufferStatus);
  Tlv::SerializeU32 (bufferStatus, validLifeTime1, TLV_VALID_TIME_INTERVAL);
  status2.TlvSerialize (bufferStatus);
  Tlv::SerializeU32 (bufferStatus, validLifeTime2, TLV_VALID_TIME_INTERVAL);
  Tlv::PrintBuffer (std::cout, bufferStatus);
  // TLV-Deserialize;
  Status status3, status4;
  uint32_t validLifeTime3, validLifeTime4;
  status3.TlvDeserialize (bufferStatus);
  Tlv::DeserializeU32 (bufferStatus, validLifeTime3, TLV_VALID_TIME_INTERVAL);
  status4.TlvDeserialize (bufferStatus);
  Tlv::DeserializeU32 (bufferStatus, validLifeTime4, TLV_VALID_TIME_INTERVAL);
  ...
  Tlv::PrintBuffer (std::cout, bufferNetworkTypes);
  //   std::cout << links << std::endl;
  ...
  Tlv::PrintBuffer (std::cout, mbbBufferList);
  ...
  mbb->TlvSerialize (mbbBuffer);
  Tlv::PrintBuffer (std::cout, mbbBuffer);
  ...
  Tlv::PrintBuffer (std::cout, emptyBufferList);
  ...
  Tlv::PrintBuffer (std::cout, parameterReportBuffer);
